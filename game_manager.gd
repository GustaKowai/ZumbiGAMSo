...
func reset_game_status():
	...
	GameManager.upgrade_revolver = [0,0,0,1] #[munição,dano,perfuração,bala curva]
	GameManager.upgrade_metralhadora = [0,0,100,100,0] #[munição,dano,spreed,velocidade de tiro,segue alvo]
	GameManager.upgrade_shotgun = [0,0,100,100,0,1] #[munição,dano,spread,alcance,quandidade de estilhaços,upgrade]
